...
const ComboCheckSelectbox = ({defaultToggleButtonText, selectBoxData, handleClickSelectItem}) => {
  const refComboSelectbox = useRef(null);
  ...
  const handleClickOutside = e => {
    const isInside = refComboSelectbox.current.contains(e.target);
    if (!isInside) {
      setIsOpenDropdown(false);
      return;
    }
  ...
  return (
    <div className="basic_text_selectbox_container" ref={refComboSelectbox}>
